...
export default async function WildcardPage() {
  ...
  if (!wildcard) {
    wildcard = {
      ...
      description: "Submissions are currently closed.",
      poster: "",
      googleFormUrl: "",
    };
  }
    ...
    <div className="min-h-screen bg-black text-white flex flex-col font-sans">
      ...
      {!wildcard.isActive ? (
        ...
        <div className="flex-grow container mx-auto px-4 flex flex-col items-center justify-center text-center py-20 max-w-xl">
          ...
          <Link
            href="/"
            className="px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold text-sm tracking-wide shadow-lg shadow-blue-500/20 transition-all duration-300 hover:scale-105"
          >
            Go to Homepage
          </Link>
        </div>
